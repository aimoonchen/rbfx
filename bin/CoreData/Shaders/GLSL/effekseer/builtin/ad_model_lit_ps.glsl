...
_LAYOUT(2) uniform sampler2D Sampler_sampler_alphaTex;
_LAYOUT(6) uniform sampler2D Sampler_sampler_blendUVDistortionTex;
_LAYOUT(4) uniform sampler2D Sampler_sampler_blendTex;
_LAYOUT(5) uniform sampler2D Sampler_sampler_blendAlphaTex;
_LAYOUT(7) uniform sampler2D Sampler_sampler_depthTex;
...
vec4 _main(PS_Input Input)
{
    ...
    vec4 _633 = Output;
    vec3 _644 = _633.xyz * ((CBPS0.fLightColor.xyz * diffuse) + CBPS0.fLightAmbient.xyz);
    Output.x = _644.x;
    Output.y = _644.y;
    Output.z = _644.z;
    ...
    vec4 _744 = Output;
    vec3 _746 = _744.xyz * CBPS0.fEmissiveScaling.x;
    Output.x = _746.x;
    Output.y = _746.y;
    Output.z = _746.z;
    ...
    vec4 _836 = Output;
    float _839 = Output.w;
    vec3 _848 = mix(CBPS0.fEdgeColor.xyz * CBPS0.fEdgeParameter.y, _836.xyz, vec3(ceil((_839 - advancedParam.AlphaThreshold) - CBPS0.fEdgeParameter.x)));
    Output.x = _848.x;
    Output.y = _848.y;
    Output.z = _848.z;
