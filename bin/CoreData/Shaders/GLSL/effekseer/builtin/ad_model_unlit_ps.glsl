...
vec4 _main(PS_Input Input)
{
    ...
    vec4 _677 = Output;
    vec3 _679 = _677.xyz * u_fEmissiveScaling.x;
    Output.x = _679.x;
    Output.y = _679.y;
    Output.z = _679.z;
    ...
    vec4 _769 = Output;
    float _772 = Output.w;
    vec3 _781 = mix(u_fEdgeColor.xyz * u_fEdgeParameter.y, _769.xyz, vec3(ceil((_772 - advancedParam.AlphaThreshold) - u_fEdgeParameter.x)));
    Output.x = _781.x;
    Output.y = _781.y;
    Output.z = _781.z;
