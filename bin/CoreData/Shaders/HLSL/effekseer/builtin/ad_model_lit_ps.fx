...
SamplerState normalTex_sampler : register(s1);
...
float4 _main(PS_Input Input)
{
    ...
    float3 texNormal = (normalTex.Sample(normalTex_sampler, Input.UV_Others.xy + UVOffset).xyz - 0.5f.xxx) * 2.0f;
    ...
    ApplyFlipbook(param_6, colorTex, colorTex_sampler, _434_fFlipbookParameter, Input.Color, advancedParam.FlipbookNextIndexUV + UVOffset, param_7, param_8);
    Output = param_6;
