...
int sol2_GraphicsLuaAPI_open(sol::state& lua)
{
    ...
    bindTexture2D["width"]              = sol::readonly_property(&Texture2D::GetWidth);
	bindTexture2D["height"]             = sol::readonly_property(&Texture2D::GetHeight);
    ...
    bindGraphics["width"]               = sol::readonly_property(&Graphics::GetWidth);
    bindGraphics["height"]              = sol::readonly_property(&Graphics::GetHeight);
