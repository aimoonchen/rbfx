...
#include "EffekseerUrho3D.SoundPlayer.h"
#include "EffekseerUrho3D.SoundResources.h"
...
{
	return false;// (bool)soundContext_->call("check_playing", reinterpret_cast<int64_t>(handle));
}
...
{
	return false;// (bool)soundContext_->call("check_playing_tag", reinterpret_cast<int64_t>(tag));
}
