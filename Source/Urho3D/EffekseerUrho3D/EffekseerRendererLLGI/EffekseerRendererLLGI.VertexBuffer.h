...
protected:
	...
	std::vector<std::shared_ptr<Urho3D::VertexBuffer>> storedVertexBuffers_;
	std::shared_ptr<Urho3D::VertexBuffer> CreateBuffer();
	std::shared_ptr<Urho3D::VertexBuffer> GetNextBuffer();

	std::shared_ptr<Urho3D::VertexBuffer> currentVertexBuffer_;
...
public:
    ...
    Urho3D::VertexBuffer* GetVertexBuffer()
	{
